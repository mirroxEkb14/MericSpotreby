 ...
 * <ul>
 * <li> {@link cz.upce.fei.bdats.gui.kontejnery.Tlacitko}: obsahuje určiná
 ...
 * definovanou šitku, a to je v rodičovské třídě {@link cz.upce.fei.bdats.gui.kontejnery.Tlacitko})
 * dědící od {@link javafx.scene.control.Button}
 * <li> {@link cz.upce.fei.bdats.gui.kontejnery.TitulkovyPanel}: obsahuje
 * nastavení, charakteristické pro veškeré komponenty v rámci panelu {@link cz.upce.fei.bdats.gui.koreny.PrikazPanel},
